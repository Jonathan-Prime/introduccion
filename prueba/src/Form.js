...
function Formulario() {
  ...
  // = Asignacion
  // == comparacion sencilla igual true
  // === comparacion estricta igual false

  let variable = 1; /* variable tipo number */
  let variable2 = '1' /* variable tipo texto */

 
  let resultadoComparacion = variable === variable2
 /* resultado de comparacion */
  console.log('resultado de comparacion', resultadoComparacion)
